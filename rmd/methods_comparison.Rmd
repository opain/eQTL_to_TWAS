...
mkdir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324
cut -f 1 -d' ' /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen_sumstats_exclGTeX.txt | tail -n +2 | uniq > /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/gene_list.txt

> /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/todo.txt
for i in $(cat /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/gene_list.txt);do
  if [ ! -f /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/eQTLGen.eQTL/${i}.done ]; then
    echo ${i} >> /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/todo.txt
  fi
done

# Create shell script to run using sbatch
cat > /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/sbatch.sh << 'EOF'
#!/bin/sh
...
ID=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/todo.txt)
...
Rscript /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/compute_weights.R \
  ...
  --output /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/eQTLGen.eQTL

EOF

sbatch --array 1-$(wc -l /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/todo.txt | cut -d' ' -f1)%400 /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/sbatch.sh
...
rdat_list<-list.files(path='/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/eQTLGen.eQTL', pattern='.RDat')
...
for(i in 1:nrow(pos)){
  load(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/',pos$WGT[i]))
  pos$N[i]<-N.tot
...
write.table(pos, '/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/eQTLGen.eQTL.pos', col.names=T, row.names=F, quote=F)
...
```{bash, eval=F, echo=T}
# Create file listing GWAS that haven't been processed.
mkdir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722
cut -f 1 -d' ' /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS_eQTL_from_fusion.txt | tail -n +2 | uniq > /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/gene_list.txt

> /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/todo.txt
for i in $(cat /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/gene_list.txt);do
  if [ ! -f /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/YFS.eQTL/${i}.done ]; then
    echo ${i} >> /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/todo.txt
  fi
done

# Create shell script to run using sbatch
cat > /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/sbatch.sh << 'EOF'
#!/bin/sh
...
ID=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/todo.txt)
...
/users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/compute_weights_V2.R \
  ...
  --PRScs_ref_path /users/k1806347/oliverpainfel/Software/PRScs/ldblk_1kg_eur \
	--ldpred2_ref_dir /scratch/prj/ukbiobank/usr/ollie_pain/GenoPredPipe/GenoPred/pipeline/resources/data/ldpred2_ref \
  --output /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/YFS.eQTL

EOF

sbatch --array 1-$(wc -l /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/todo.txt | cut -d' ' -f1)%400 /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/sbatch.sh
...
# Read in list of RDat files
rdat_list<-list.files(path='/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/YFS.eQTL', pattern='.RDat')
...
# Read in each RDat file to retrieve N
for(i in 1:nrow(pos)){
  load(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/',pos$WGT[i]))
  pos$N[i]<-N.tot
  pos$CHR_pos[i]<-snps$V1[1]
}
...
write.table(pos, '/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/YFS.eQTL.pos', col.names=T, row.names=F, quote=F)
...
```{bash, eval=F, echo=T}
sbatch -p neurohack_cpu,cpu --mem 30G -n 5 -t 20 /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/Predicting-TWAS-features/FeaturePred.V2.0.R \
	--PLINK_prefix_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION/1000G.EUR. \
	--weights /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324/eQTLGen.eQTL.pos \
	--weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_140324 \
	...
	--output /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/1kg_pred_exp/eQTLGen.eQTL
```
...
sbatch -p cpu --mem 10G -n 1 /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/Predicting-TWAS-features/FeaturePred.V2.0.R \
	--PLINK_prefix_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. \
	--weights /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS.eQTL.pos \
	--weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS \
	--ref_ld_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. \
	--plink /users/k1806347/oliverpainfel/Software/plink1.9.sh \
	--n_cores 1 \
	--save_score T \
...
eqtl<-fread('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/1kg_pred_exp/YFS2.eQTL/FeaturePredictions_YFS.eQTL.txt.gz')
...
library(ggplot2)
png('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/1kg_pred_exp/YFS2_cor_plot.png', units='px', width=3000, height=4000, res=300)
ggplot(cor_res_melt, aes(x=paste0(Var1,' vs. ',Var2), y=value)) +
  geom_boxplot() +
  coord_flip()
dev.off()
...
eqtl_sumstats<-fread('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen_sumstats_exclGTeX.txt')
...
for(i in 1:length(genes)){
  ...
  # Write out results
  fwrite(eqtl_sumstats_i, paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/per_gene_eqtl/',genes[i],'.gz'), quote=F, sep='\t')
}
...
pos<-fread('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen.eQTL.pos')

# For each gene
for(i in 1:nrow(pos)){
  for(mod in c('top1','sbayesr','sbayesr_robust','dbslmm','prscs','susie')){
    if(!file.exists(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/pseudo_res/', pos$ID[i],'.',mod))){
      system(paste0('/users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.pseudo.R --sumstats /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/per_gene_eqtl/',pos$ID[i],'.gz --extract_weight ',pos$ID[i],' --weights /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen.eQTL.pos --weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen --ref_ld_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. --out /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/pseudo_res/', pos$ID[i],'.',mod,' --chr ',pos$CHR[i],' --force_model ',mod))
    }
  }
}
...
for(i in 1:nrow(pos)){
  for(mod in c('top1','sbayesr','sbayesr_robust','dbslmm','prscs','susie')){
    res_i_mod<-fread(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/pseudo_res/', pos$ID[i],'.',mod))
...
saveRDS(table(rank_diff$pseudo_top_mod, rank_diff$obs_top_mod),'/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/best_pseudo_comp.rds')
...
png('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/best_pseudo_comp.png', res=300, units='px', width=1000, height=1000)
...
![](/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/best_pseudo_comp.png){width=50%}

```{r, eval=T, echo=F}

tmp<-readRDS('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo/best_pseudo_comp.rds')
...
mkdir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo2
for chr in $(seq 1 22);do
  sbatch -p cpu --mem 10G /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.pseudo_V2.R \
    --sumstats /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen_sumstats_exclGTeX.txt \
    --weights /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_300722/eQTLGen.eQTL.pos \
    --weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGenall_300722 \
    --ref_ld_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. \
    --out /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo2/pseudo_res_chr${chr} \
    --chr ${chr} \
    --all_mod T
done
...
mkdir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs
...
for chr in $(seq 1 22);do
  sbatch -p cpu --exclude=nodeb11,nodeb16,nodeb09,nodeb18 --mem 10G /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.pseudo_V2.R \
    --sumstats /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS_eQTL_from_fusion.txt \
  	...
  	--weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/FUSION \
    --ref_ld_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. \
    --out /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/pseudo_res_chr${chr} \
    --chr ${chr} \
    --all_mod T
done
...
pseudo_res_2<-NULL
for(i in 1:22){
  pseudo_res_2<-rbind(pseudo_res_2, fread(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/pseudo_res_chr',i)))
}
...
# Crosstab the selected observed and pseudoval-selected best model
saveRDS(table(rank_diff$pseudo_top_mod, rank_diff$obs_top_mod),'/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp.rds')
table(rank_diff$pseudo_top_mod, rank_diff$obs_top_mod)
table(rank_diff$pseudo_top_mod)
table(rank_diff$obs_top_mod)
...
bitmap('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp.png', res=300, units='px', width=1000, height=1000)
ggplot(rank_diff, aes(x=top_R, y=pseudo_R)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, colour='red') +
  coord_fixed() +
...
bitmap('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp_hist.png', res=300, units='px', width=1500, height=1000)
ggplot(rank_diff, aes(x=diff)) +
  geom_histogram() +
  theme_half_open() +
  background_grid() +
...
![](/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp.png){width=50%}

![](/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp_hist.png){width=50%}

```{r, eval=T, echo=F}

tmp<-readRDS('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_fusion_yfs/best_pseudo_comp.rds')
...
mkdir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_eqtl_yfs

for chr in $(seq 1 22);do
  sbatch -p cpu --mem 10G /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.pseudo_V2.R \
    --sumstats /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS_eQTL_from_fusion.txt \
  	--weights /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722/YFS.eQTL.pos \
  	--weights_dir /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFSall_300722 \
    --ref_ld_chr /users/k1806347/oliverpainfel/Data/1KG/FUSION//1000G.EUR. \
    --out /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_eqtl_yfs/pseudo_res_chr${chr} \
    --chr ${chr} \
    --all_mod T
done
...
sbatch -p cpu --mem 10G -n 1 --nodes 1 /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/eQTL_mbat_combo.R \
	...
	--plink_ref_keep /users/k1806347/oliverpainfel/Data/1KG/GenoPred/v2.0.0/keep_files/EUR.keep \
	--gcta /users/k1806347/oliverpainfel/Software/gcta_1.94.sh \
  --output /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS.mbat.combo.chr${chr}
done
...
sbatch -p cpu --exclude erc-hpc-comp025 --mem 10G -n 1 --nodes 1 /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/private/eQTL_mbat_combo.R \
	...
	--plink_ref_keep /users/k1806347/oliverpainfel/Data/1KG/GenoPred/v2.0.0/keep_files/EUR.keep \
	--gcta /users/k1806347/oliverpainfel/Software/gcta_1.94.sh \
  --output /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/eQTLGen/eQTLGen_exclGTEx.mbat.combo.chr${chr}
done
...
for chr in $(seq 1 22);do
  sbatch -p cpu --mem 10G /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.pseudo_LDAK_V2.R \
    ...
    --out /users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/pseudo_ldak_res_chr${chr} \
    --chr ${chr} \
...
opt$sumstats<-'/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/YFS/YFS_eQTL_from_fusion.txt'
...
opt$out<-'/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/pseudo_ldak_res_chr11'
opt$chr<-11
...
pseudo_res_2<-NULL
for(i in 1:22){
  pseudo_res_2<-rbind(pseudo_res_2, fread(paste0('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/pseudo_ldak_res_chr',i,'.ldak.pseudo.txt')))
}
...
# Crosstab the selected observed and pseudoval-selected best model
saveRDS(table(rank_diff$pseudo_top_mod, rank_diff$obs_top_mod),'/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/best_pseudo_ldak_comp.rds')
table(rank_diff$pseudo_top_mod, rank_diff$obs_top_mod)
table(rank_diff$pseudo_top_mod)
table(rank_diff$obs_top_mod)
...
png('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/best_pseudo_ldak_comp.png', res=300, units='px', width=1000, height=1000)
ggplot(rank_diff, aes(x=top_R, y=pseudo_R)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, colour='red') +
  coord_fixed() +
...
png('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/best_pseudo_ldak_comp_hist.png', res=300, units='px', width=1500, height=1000)
ggplot(rank_diff, aes(x=diff)) +
  geom_histogram() +
  theme_half_open() +
  background_grid() +
...
png('/users/k1806347/oliverpainfel/Analyses/eQTL_to_TWAS/data/pseudo_ldak_yfs/pseudo_ldak_model_comp.png', res=300, units='px', width=2000, height=2000)
