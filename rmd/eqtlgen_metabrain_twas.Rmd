...
panel<-c('Cerebellum','Hippocampus','Spinalcord')
...
# Read in list of RDat files
rdat_list<-list.files(path='/users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/MetaBrain_Cortex/MetaBrain_Cortex.eQTL', pattern='.RDat')

# Start making pos file
pos<-data.frame(PANEL='MetaBrain_Cortex.eQTL',
                WGT=paste0('MetaBrain_Cortex.eQTL/',rdat_list),
                ID=gsub('\\..*','',rdat_list))

# Insert CHR, P0 and P1 (GRCh=37)
library(biomaRt)
ensembl = useEnsembl(biomart="ensembl", dataset="hsapiens_gene_ensembl", GRCh=37, host="https://uswest.ensembl.org")
Genes<-getBM(attributes=c('ensembl_gene_id_version','chromosome_name','start_position','end_position'), mart = ensembl)
Genes$ensembl_gene_id_version<-gsub('\\..*','',Genes$ensembl_gene_id_version)
names(Genes)<-c('ID','CHR','P0','P1')
Genes<-Genes[complete.cases(Genes),]
...
# Read in each RDat file to retrieve N
for(i in 1:length(rdat_list)){
  load(paste0('/users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/MetaBrain_Cortex/MetaBrain_Cortex.eQTL/',rdat_list[i]))
  pos$N[i]<-N.tot
  pos$CHR_pos[i]<-snps$V1[1]
  pos$P0_pos[i]<-min(snps$V4)
  pos$P1_pos[i]<-max(snps$V4)
...
write.table(pos, '/users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/MetaBrain_Cortex/MetaBrain_Cortex.eQTL.pos', col.names=T, row.names=F, quote=F)
...
mkdir /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex
...
for chr in $(seq 1 22); do
  ...
  sbatch -p cpu --mem 20G -n 1 /users/k1806347/oliverpainfel/Software/Rscript.sh /users/k1806347/oliverpainfel/Software/MyGit/eQTL_to_TWAS/FUSION.assoc_test.edit.R \
    --sumstats /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/SCZ.cleaned.munged.sumstats.gz \
    --weights /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/MetaBrain_Cortex/MetaBrain_Cortex.eQTL.pos \
    --weights_dir /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/MetaBrain_Cortex/ \
    --ref_ld_chr /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/FUSION/LDREF/1000G.EUR. \
    --out /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex/SCZ.TWAS.MetaBrain_Cortex.chr${chr} \
    --chr ${chr} \
    --coloc_P 1 \
    --GWASN 126282
...
# Combine per chromosome results
head -n 1 /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex/SCZ.TWAS.MetaBrain_Cortex.chr1 > /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex/SCZ.TWAS.MetaBrain_Cortex.GW      
tail -n +2 -q /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex/SCZ.TWAS.MetaBrain_Cortex.chr* >> /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/MetaBrain_Cortex/SCZ.TWAS.MetaBrain_Cortex.GW
...
# Combine per chromosome results
head -n 1 /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/PsychENCODE/SCZ.TWAS.PsychENCODE.chr1 > /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/PsychENCODE/SCZ.TWAS.PsychENCODE.GW      
tail -n +2 -q /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/PsychENCODE/SCZ.TWAS.PsychENCODE.chr* >> /users/k1806347/oliverpainfel/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/SCZ/twas/PsychENCODE/SCZ.TWAS.PsychENCODE.GW

```

***

## Compare MetaBrain and PsychENCODE results
...
twas_metabrain_gene<-merge(twas_metabrain_gene,twas_metabrain[,c('ID','COLOC.PP4'), with=F],by='ID')
...
twas_psychencode_gene<-merge(twas_psychencode_gene,twas_psychencode_r2[,c('ID','COLOC.PP4'), with=F],by='ID')
