...
opt$extract<-'/users/k1806347/brc_scratch/Data/ldsc/w_hm3.snplist'
opt$sumstats<-'/scratch/groups/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/YFS/YFS_eQTL_from_fusion.txt'
opt$output<-'/scratch/groups/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/YFS/twas_weights_from_eQTL/YFS'
opt$gctb<-'/users/k1806347/brc_scratch/Software/gctb_2.03beta_Linux/gctb_203.sh'
opt$gctb_ref<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/LD_matrix/GCTB_shared/ukbEURu_hm3_shrunk_sparse/ukbEURu_hm3_v3_50k_chr'
opt$plink_ref_chr<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/1KGPhase3.w_hm3.chr'
opt$plink_ref_keep<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/keep_files/EUR_samples.keep'
opt$PRScs_path<-'/users/k1806347/brc_scratch/Software/PRScs.sh'
opt$PRScs_ref_path<-'/users/k1806347/brc_scratch/Software/PRScs/ldblk_1kg_eur'
opt$ld_blocks<-'/users/k1806347/brc_scratch/Data/LDetect/EUR'
opt$rscript<-'/users/k1806347/brc_scratch/Software/Rscript.sh'
opt$dbslmm<-'/users/k1806347/brc_scratch/Software/DBSLMM/software'
...
sbatch -p brc,shared --mem 10G -n 1 /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/Predicting-TWAS-features/FeaturePred.V2.0.R \
	...
	--plink /users/k1806347/brc_scratch/Software/plink1.9.sh \
	--n_cores 1 \
	--score_files /scratch/groups/biomarkers-brc-mh/TWAS_resource/eQTL_to_TWAS/data/1kg_pred_exp/YFS.BLOOD.RNAARR/SCORE_FILES \
  --save_ref_expr T \
	--memory 10000 \
	--all_mod T \
