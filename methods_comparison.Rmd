...
Rscript FeaturePred.V2.0.R \
	...
	--plink plink \
	--n_cores 1 \
	--score_files YFS.BLOOD.RNAARR/SCORE_FILES \
	--ref_expr YFS.BLOOD.RNAARR/Reference_Expression \
	--memory 10000 \
	--all_mod T \
	--pigz pigz \
	--ref_maf LDREF/1000G.EUR. \
	--output gtex_v8/YFS.BLOOD.RNAARR
...
Rscript FeaturePred.V2.0.R \
	--PLINK_prefix_chr LDREF/1000G.EUR. \
	--weights YFS.eQTL/YFS.eQTL.pos \
	--weights_dir YFS.eQTL \
	--ref_ld_chr LDREF/1000G.EUR. \
	--plink plink \
	--n_cores 1 \
	--score_files YFS.eQTL/SCORE_FILES \
	--ref_expr YFS.eQTL/Reference_Expression \
	--memory 10000 \
	--all_mod T \
	--pigz pigz \
	--ref_maf LDREF/1000G.EUR. \
	--output gtex_v8/YFS.eQTL
